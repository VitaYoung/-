...
namespace Todos
{
    ...
    sealed partial class App : Application
    {
        ...
        public static SQLiteConnection conn = new SQLiteConnection("data.db");
        private void LoadDatabase()
        {
            string sql = @"CREATE TABLE IF NOT EXISTS Message(Id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                           Title VARCHAR(140), Description VARCHAR(140), Time VARCHAR(140));";
